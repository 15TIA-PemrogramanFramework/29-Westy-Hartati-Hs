...
<!--main content start-->
 ...
 <div class="panel panel-default">
    ...
    <div class="form-group" style="padding-top:20px;">
        ...
        <input type="text" placeholder="Masukkan ID Karyawan"  class="form-control" name="id_karyawan">
    </div>
    <div class="form-group">
        <label>Nama Karyawan</label>
        <input type="text" placeholder="Masukkan Nama Karyawan" class="form-control" name="nama_karyawan">
    </div>
    <div class="form-group" style="padding-top:20px;">
