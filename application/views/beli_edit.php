...
<!--main content start-->
 ...
 <div class="panel panel-default">
    ...
    <div class="form-group">
        ...
        <input type="text" value="<?php echo $jumlah_barang; ?>" class="form-control" name="jumlah_barang">
    </div>

    <div class="form-group">
        <label>Tanggal Beli</label>
        <input type="date" value="<?php echo $tanggal_beli; ?>" class="form-control form-control-line" name="tanggal_beli">
    </div>
