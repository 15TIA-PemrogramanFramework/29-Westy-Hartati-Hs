...
<!--main content start-->
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
            <?php echo anchor(site_url("Home/tambah_data_customer"),'<i class="fa fa-plus">&nbsp; Input Data Customer</i>', 'class="btn btn-primary"');?>
    </div>
</div>
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
		...
		<tr>
            ...
            <td><button ><?php echo anchor(site_url("home/customer_edit/".$value->id_customer),
            '<i class="fa fa-pencil"></i>');?>&nbsp;</button>&nbsp;
                <button><?php echo anchor(site_url("home/hapus_customer/".$value->id_customer),
