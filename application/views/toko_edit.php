...
<!--main content start-->
 ...
 <div class="panel panel-default">
    ...
    <div class="form-group" style="padding-top:20px;">
        ...
        <input type="text" value="<?php echo $nama_toko; ?>"  class="form-control" name="nama_toko">
    </div>
    <div class="form-group">
        <label>Alamat Toko</label>
        <input type="text" value="<?php echo $alamat_toko; ?>" class="form-control" name="alamat_toko">
    </div>
