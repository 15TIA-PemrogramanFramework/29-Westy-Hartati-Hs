...
<!--main content start-->
	...
	<div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
			<?php echo anchor(site_url("Home/tambah_data_barang"),'<i class="fa fa-plus">&nbsp; Input Data Barang</i>', 'class="btn btn-primary"');?>
	</div>
</div>
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
		...
		<tr>
			...
			<td><?php echo anchor(site_url("home/barang_edit/".$value->id_barang),
			'<i class="fa fa-pencil"></i>');?>&nbsp;&nbsp;
				<?php echo anchor(site_url("home/hapus_barang/".$value->id_barang),
