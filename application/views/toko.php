...
<!--main content start-->
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
            <?php echo anchor(site_url("Home/tambah_data_toko"),'<i class="fa fa-plus">&nbsp; Input Data Toko</i>', 'class="btn btn-primary"');?>
    </div>
</div>
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
		...
		<tr>
            ...
            <td><button ><?php echo anchor(site_url("home/toko_edit/".$value->id_toko),
            '<i class="fa fa-pencil"></i>');?>&nbsp;</button>&nbsp;
                <button><?php echo anchor(site_url("home/hapus_toko/".$value->id_toko),
